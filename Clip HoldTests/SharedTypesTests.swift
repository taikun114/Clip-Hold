...
struct SharedTypesTests {
    ...
    func testItemFilterAndSortCases() {
        ...
        #expect(allFilters.contains(.codeAll))
        #expect(allFilters.contains(.codeSwift))
        #expect(allFilters.contains(.codeJavaScript))
        #expect(allFilters.contains(.codePython))
        #expect(allFilters.contains(.codeYAML))
        #expect(allFilters.contains(.codeTOML))
        #expect(allFilters.contains(.codeMarkdown))
        #expect(allFilters.contains(.codeGraphQL))
        #expect(allFilters.contains(.codeEnv))
        #expect(allFilters.contains(.codeRust))
        #expect(allFilters.contains(.codeGo))
        #expect(allFilters.contains(.codeCPP))
        #expect(allFilters.contains(.codeJavaKotlin))
