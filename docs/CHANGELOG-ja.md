...
- **「クイックオーバーレイ」機能を追加**
  - 履歴や定型文を、ショートカットキーを押しながらマウスカーソルを動かすだけで簡単にコピーできるクイックオーバーレイ機能が追加されました。ほとんどの操作はショートカットキーを押しながらマウスカーソルを動かしてショートカットキーを離すことでアクションが実行されるため、わざわざクリックしなくても簡単に操作できるように設計されています。
