...
struct QuickOverlayTutorialView: View {
    ...
    private let pages: [TutorialPage] = [
        TutorialPage(
            ...
            title: "クイックオーバーレイ",
            description: "クイックオーバーレイは、設定されたショートカットキーを押し続けている間だけ表示されるオーバーレイです。デフォルトでは、^ (Control) + ⌘ (Command)キーで定型文オーバーレイ、⌥ (Option) + ⌘ (Command)キーで履歴オーバーレイを開くことができます。\nクイックオーバーレイではマウスカーソルを動かすだけで簡単に操作できるように設計されています。"
        ),
        TutorialPage(
            image: "Clip Hold Overlay HowTo Copy Content",
            title: "項目をコピーする",
            description: "履歴または定型文をコピーしたい場合、オーバーレイを開いたままコピーしたい項目にマウスカーソルを合わせ、ショートカットキーを離すことでコピーすることができます。\n設定で「クイックペースト」がオンになっている場合、コピーされた後に自動でペーストされます（履歴の場合、「テキストに限定」設定も適用されます）。"
        ),
        TutorialPage(
            image: "Clip Hold Overlay HowTo Copy as Plain Text",
            title: "履歴を標準テキストとしてコピーする",
            description: "履歴項目がリッチテキストの場合、項目の右側にある「標準テキストとしてコピー」ボタンにマウスカーソルを合わせてショートカットキーを離すことで、標準テキストとしてコピーすることができます。\n設定で「クイックペースト」がオンになっている場合、コピーされた後に自動でペーストされます。"
        ),
        TutorialPage(
            image: "Clip Hold Overlay HowTo Change and Copy",
            title: "項目を変更してコピーする",
            description: "元となる履歴や定型文を変更してコピーしたい場合、項目の右側にある「変更してコピー...」にマウスカーソルを合わせてショートカットキーを離すことで、「項目を変更してコピー」ウィンドウが開いて項目を変更してコピーすることができます。"
        ),
        TutorialPage(
        ...
        TutorialPage(
            ...
            description: "プリセットメニューでは、マウスカーソルを動かすだけで簡単にプリセットを切り替えることができます。\nプリセットを切り替えるには、切り替えたいプリセット名にマウスカーソルを合わせ、そのままメニューの左か右にマウスカーソルを移動させることでプリセットが切り替わります。プリセットの切り替えをキャンセルしたい場合はメニューの上か下にマウスカーソルを移動させると、プリセットを切り替えずにメニューを閉じることができます。"
        ),
        TutorialPage(
            image: "Clip Hold Overlay HowTo New Preset",
            title: "定型文プリセットを操作する (3/3)",
            description: "新規プリセットを作成するには、プリセットメニューにある「新規プリセット...」にマウスカーソルを合わせてショートカットキーを離すことで、「プリセットを追加」ウィンドウが開いてプリセットを作成することができます。\nこのメニュー項目では誤操作を防止するため、項目の左右にマウスカーソルを動かしてもアクションは実行されず、メニューが閉じます。"
        ),
        TutorialPage(
            image: "Clip Hold Overlay HowTo New",
            title: "定型文を追加 / 新規コピーする",
            description: "定型文オーバーレイでは、オーバーレイの左下にある「追加」にマウスカーソルを合わせてショートカットキーを離すことで、「定型文を追加」ウィンドウが開いて定型文の追加を行うことができます。\n履歴オーバーレイでは、オーバーレイの左下にある「新規コピー」にマウスカーソルを合わせてショートカットキーを離すことで、「テキストを入力して新規コピー」ウィンドウが開いて新たなコピーの作成を行うことができます。"
        ),
        TutorialPage(
            image: "Clip Hold Overlay HowTo Open Window",
            title: "定型文 / 履歴ウィンドウを開く",
            description: "オーバーレイの右下にある「定型文ウィンドウを開く」（定型文オーバーレイ）または「履歴ウィンドウを開く」（履歴オーバーレイ）にマウスカーソルを合わせてショートカットキーを離すことで、定型文ウィンドウまたは履歴ウィンドウを開くことができます。"
        )
    ]
